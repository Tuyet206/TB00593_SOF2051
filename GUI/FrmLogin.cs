...
namespace GUI
{
    public partial class FrmLogin : Form
    {
        ...
        internal static string Encryption(string text)
        {
        ...
        public void btndangnhap_Click(object sender, EventArgs e)
        {
            ...
            if (busNhanVien.NVDangNhap(nv))//successfull login
            {
                //login = true;
                FrmMain.email = nv.EmailNV; // truyen email dang nhap cho frmMain
        ...
        private void btnQuenmk_Click(object sender, EventArgs e)
        {
            if (txtemail.Text != "")
            {
                if (busNhanVien.QuenMK(txtemail.Text))//show form input email. If true will send pass random
                {
